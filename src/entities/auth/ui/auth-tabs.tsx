...
export const AuthTabs: FC<AuthTabsProps> = () => {
  ...
  return (
    <div className="mb-4 flex min-h-[44px] w-full cursor-pointer flex-row overflow-hidden rounded-md border border-solid border-primary500 xs:h-[30px] xs:min-h-[30px]">
      <Link
        href="/auth/sign-in"
