...
export const UserProfile: FC<UserDropdownProps> = ({ userData, isLoading, isMobile }) => {
  ...
  return (
    <div className={`mr-0.5 flex items-center ${isMobile ? 'gap-2' : 'gap-0.5'}`}>
      ...
      <span className="body_medium_16pt overflow-hidden text-ellipsis whitespace-nowrap text-grayscale800 dark:text-grayscale200 md:max-w-[100px] lg:max-w-[200px]">
